{
	...
	},
	{
		...
		items = {
			{
				editor_view_abridged = "Play banter(s): Style",
				filter_type = "banter",
				reference_id = "Style",
				type = "PlayBanterEffect",
			},
		...
		map = "ehvTmk7",
		name = "Position#515 COmment1 (Act2Flavor)",
		path = "Position COmment1",
		type = "Position",
	},
	{
		BanterTriggerEffects = {
		...
		items = {
			{
				editor_view_abridged = "If any of banter(s) played: OnGuard",
				filter_type = "banter",
				reference_id = "OnGuard",
				type = "BanterHasPlayed",
			},
			{
				editor_view_abridged = "Play banter(s): Hearyou",
				filter_type = "banter",
				reference_id = "Hearyou",
				type = "PlayBanterEffect",
			},
		},
		map = "ehvTmk7",
		name = "Position#301 Hearyou (Act2Flavor)",
		path = "Position Hearyou",
		type = "Position",
	},
	{
		BanterTriggerEffects = {
	...
	},
	{
		...
		items = {
			{
				editor_view_abridged = "Play banter(s): OnGuard",
				filter_type = "banter",
				reference_id = "OnGuard",
				type = "PlayBanterEffect",
			},
		...
		map = "ehvTmk7",
		name = "Position#148 COmment2 (Act2Flavor)",
		path = "Position COmment2",
		type = "Position",
	},
	{
		BanterTriggerEffects = {
