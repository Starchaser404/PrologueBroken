return {
					...
					PlaceObj('SE_OnEnterMapVisual', {
						...
						'Effects', {
							PlaceObj('PlaySetpiece', {
								setpiece = "LandingOnSeagull",
							}),
							PlaceObj('UnitStartConversation', {
								Conversation = "Enduphere",
							}),
						},
					}),
				},
	...
	Given = false,
		...
		PlaceObj('ModItemConversation', {
			...
			PlaceObj('ConversationPhrase', {
				...
				KeywordT = T(724520438286, --[[ModItemConversation GCExStephane KeywordT]] "What do you mean?"),
				Lines = {
					PlaceObj('ConversationLine', {
						Character = "GCExStephane",
	...
	PlaceObj('ModItemAppearancePreset', {
		Body = "CODWW2_en_md_f_bd_05",
		Hat = "NPCPastor_Hat_01",
		Hat2Color = PlaceObj('ColorizationPropSet', {
			'EditableColor1', RGBA(247, 135, 129, 255),
			'EditableColor2', RGBA(177, 22, 14, 255),
			'EditableColor3', RGBA(63, 60, 60, 255),
		}),
		HatColor = PlaceObj('ColorizationPropSet', {
			'EditableColor1', RGBA(190, 182, 182, 255),
			'EditableColor2', RGBA(6, 5, 5, 255),
			'EditableColor3', RGBA(206, 209, 212, 255),
		}),
		Head = "Head_Lami",
		Pants = "CODWW2_en_md_f_pt_02",
		group = "GCEXPrologueNPCs",
		id = "Stitches",
	}),
	PlaceObj('ModItemFolder', {
	...
	Given = false,
					...
					Text = T(236496326025, --[[ModItemQuestsDef ChurchOfBlood Text]] "In exchange for a boat you agreed to help the Priestess. Follow Stitches to her flock in the Jungle! "),
				}),
			},
			QuestId = "GearUp",
			Variables = {
		...
		PlaceObj('ModItemConversation', {
			...
			PlaceObj('ConversationPhrase', {
				...
				Lines = {
					PlaceObj('ConversationLine', {
						Character = "GCExStitches",
						Text = T(704601762572, --[[ModItemConversation ChurchQuestStart Text voice:GCExStitches section:ChurchQuestStart keyword:Greeting]] "Bones and ashes! We have guests, my flock!? Whoever you are, turn around! Leave now! Leave as long as you are still alive!"),
						param_bindings = false,
					}),
				},
				id = "Greeting",
				...
				PlaceObj('ConversationPhrase', {
					...
					PlaceObj('ConversationPhrase', {
						...
						PlaceObj('ConversationPhrase', {
							Keyword = "What price?",
							KeywordT = T(849837002056, --[[ModItemConversation ChurchQuestStart KeywordT]] "What price?"),
							Lines = {
								PlaceObj('ConversationLine', {
									Character = "GCExStitches",
									Text = T(284542997764, --[[ModItemConversation ChurchQuestStart Text voice:GCExStitches section:ChurchQuestStart keyword:What price?]] "There is a boat, my boat, it's on the other side of the island. As there is nothing of value you could offer me, except your lives. What about this, a donation of a life for a boat, how does that sound to you?"),
									param_bindings = false,
								}),
							},
							...
							PlaceObj('ConversationPhrase', {
								...
								Lines = {
									PlaceObj('ConversationLine', {
										Character = "GCExStitches",
										Text = T(273327164732, --[[ModItemConversation ChurchQuestStart Text voice:GCExStitches section:ChurchQuestStart keyword:Are you serious?]] "I never am, but I am always sincere. One life, to save five, does this not sound fair to you?"),
										param_bindings = false,
									}),
								},
								id = "Areyouserious2",
								...
								PlaceObj('ConversationPhrase', {
									...
									Lines = {
										...
										PlaceObj('ConversationLine', {
											Character = "GCExStitches",
											Text = T(208247280631, --[[ModItemConversation ChurchQuestStart Text voice:GCExStitches section:ChurchQuestStart keyword:How about, a boat and we spare YOUR life! Does this sound fair to you?]] "Do what you must. You can kill me, but I am dead already! Besides, without me you will never find it, let alone survive out here..."),
											param_bindings = false,
										}),
									},
									...
									PlaceObj('ConversationPhrase', {
										...
										Lines = {
											PlaceObj('ConversationLine', {
												Character = "GCExStitches",
												Text = T(900249276083, --[[ModItemConversation ChurchQuestStart Text voice:GCExStitches section:ChurchQuestStart keyword:Then you will show us the way!]] "Is that so? It's much easier to die here on the beach, outsider. I can give you some poison to spare the suffering and horror you will encounter.\n"),
												param_bindings = false,
											}),
											PlaceObj('ConversationInterjectionList', {
												Interjections = {
													PlaceObj('ConversationInterjection', {
														Lines = {
															PlaceObj('ConversationLine', {
																Character = "GCExGaston",
																Text = T(342783999250, --[[ModItemConversation ChurchQuestStart Text voice:GCExGaston section:ChurchQuestStart keyword:Then you will show us the way!]] "I could be convinced if you serve the poison with some Bordeaux!"),
																param_bindings = false,
															}),
														},
														param_bindings = false,
										...
										PlaceObj('ConversationPhrase', {
											Effects = {
												...
												PlaceObj('GroupSetBehaviorAdvanceTo', {
													MarkerGroup = "Act2QuestTribePosition",
													TargetUnit = "Act2QuestTribe",
													param_bindings = false,
												}),
											},
											GoTo = "<end conversation>",
		...
		PlaceObj('ModItemSetpiecePrg', {
			Map = "ehvTmk7",
			MapPatchPath = "Mod/GCExPrologue/MapPatches/SetPieces/NewSetpiece_qwmYfpw/ehvTmk7.patch",
			affected_grids = {},
			compacted_obj_boxes = {},
			group = "Act2Land",
			hidden_actors = false,
			id = "Path",
			mapName = "NewSetpiece_qwmYfpw",
			obj_hashes = {
				1799227864414658255,
			},
			PlaceObj('SetpieceFadeOut', {}),
			PlaceObj('SetpieceCamera', {
				LookAt1 = point(206109, 189419, 20576),
				Pos1 = point(203655, 193755, 20995),
			}),
			PlaceObj('SetpieceFadeIn', {
				FadeInDelay = 0,
				Wait = false,
			...
			PlaceObj('SetpieceCamera', {
				...
				LookAt1 = point(206109, 189419, 20576),
				LookAt2 = point(218533, 165885, 19211),
				Movement = "decelerated",
				Pos1 = point(203655, 193755, 20995),
				Pos2 = point(220772, 170293, 19957),
			}),
			PlaceObj('SetpieceFadeOut', {
				FadeOutTime = 1700,
			}),
			PlaceObj('SetpieceCamera', {
				CamType = "Tac",
				Duration = 0,
				LookAt1 = point(206109, 189418, 20576),
				Pos1 = point(203655, 193755, 20995),
				Zoom = 1300,
			}),
		}),
		PlaceObj('ModItemConversation', {
			AssignToGroup = "Act2Land",
			DefaultActor = "GCExNumb",
			campaign = "GCEXPrologue",
			group = "Act2Land",
			id = "WhatNow",
			PlaceObj('ConversationPhrase', {
						...
						Interjections = {
							PlaceObj('ConversationInterjection', {
								Lines = {
									PlaceObj('ConversationLine', {
										Character = "GCExNumb",
										Text = T(813042002698, --[[ModItemConversation WhatNow Text voice:GCExNumb section:WhatNow keyword:Greeting]] "That's all Pete Tong to me! There is something fishy about all this..."),
										param_bindings = false,
									}),
								},
								param_bindings = false,
						...
						Interjections = {
							PlaceObj('ConversationInterjection', {
								Lines = {
									PlaceObj('ConversationLine', {
										Character = "GCExGasket",
										Text = T(367611166105, --[[ModItemConversation WhatNow Text voice:GCExGasket section:WhatNow keyword:Greeting]] "I don't like the looks of it either."),
										param_bindings = false,
									}),
								},
								param_bindings = false,
						...
						Interjections = {
							PlaceObj('ConversationInterjection', {
								Lines = {
									PlaceObj('ConversationLine', {
										Character = "GCExGumpy",
										Text = T(750982794989, --[[ModItemConversation WhatNow Text voice:GCExGumpy section:WhatNow keyword:Greeting]] "Maybe the people on Erny were right about the curse..."),
										param_bindings = false,
									}),
								},
								param_bindings = false,
						...
						Interjections = {
							PlaceObj('ConversationInterjection', {
								Lines = {
									PlaceObj('ConversationLine', {
										Character = "GCExNumb",
										Text = T(671154019146, --[[ModItemConversation WhatNow Text voice:GCExNumb section:WhatNow keyword:Greeting]] "Oh come on Mate, not you too. Biff fell for that Porky Pie as well!"),
										param_bindings = false,
									}),
								},
								param_bindings = false,
						...
						Interjections = {
							PlaceObj('ConversationInterjection', {
								Lines = {
									PlaceObj('ConversationLine', {
										Character = "GCExGaston",
										Text = T(632388178602, --[[ModItemConversation WhatNow Text voice:GCExGaston section:WhatNow keyword:Greeting]] "You probably 'ave just watched too many movies..."),
										param_bindings = false,
									}),
								},
								param_bindings = false,
						...
						Interjections = {
							PlaceObj('ConversationInterjection', {
								Lines = {
									PlaceObj('ConversationLine', {
										Character = "GCExStogie",
										Text = T(717067948424, --[[ModItemConversation WhatNow Text voice:GCExStogie section:WhatNow keyword:Greeting]] "Here is something strange going on, that's for sure. So we should be on our guards!"),
										param_bindings = false,
									}),
								},
								param_bindings = false,
						...
						Interjections = {
							PlaceObj('ConversationInterjection', {
								Lines = {
									PlaceObj('ConversationLine', {
										Character = "GCExCougar",
										Text = T(862486360931, --[[ModItemConversation WhatNow Text voice:GCExCougar section:WhatNow keyword:Greeting]] "Agreed, let's be on our watch, Soldiers. "),
										param_bindings = false,
									}),
								},
								param_bindings = false,
						...
						Interjections = {
							PlaceObj('ConversationInterjection', {
								Lines = {
									PlaceObj('ConversationLine', {
										Character = "GCExGaston",
										Text = T(177001603381, --[[ModItemConversation WhatNow Text voice:GCExGaston section:WhatNow keyword:Greeting]] "Oui! And we should follow that path, you see the tracks, footprints!"),
										param_bindings = false,
									}),
								},
								param_bindings = false,
						...
						Interjections = {
							PlaceObj('ConversationInterjection', {
								Lines = {
									PlaceObj('ConversationLine', {
										Character = "GCExStogie",
										Text = T(892866853338, --[[ModItemConversation Enduphere Text voice:GCExStogie section:Enduphere keyword:Greeting2]] "Tough landing, but I've seen worse!"),
										param_bindings = false,
									}),
								},
								param_bindings = false,
						...
						Interjections = {
							PlaceObj('ConversationInterjection', {
								Lines = {
									PlaceObj('ConversationLine', {
										Character = "GCExCougar",
										Text = T(805324384708, --[[ModItemConversation Enduphere Text voice:GCExCougar section:Enduphere keyword:Greeting2]] "Only half of the squad is accounted for. We should assess the situation and figure out how and where we've landed."),
										param_bindings = false,
									}),
								},
								param_bindings = false,
						...
						Interjections = {
							PlaceObj('ConversationInterjection', {
								Lines = {
									PlaceObj('ConversationLine', {
										Character = "GCExNumb",
										Text = T(995796791175, --[[ModItemConversation Enduphere Text voice:GCExNumb section:Enduphere keyword:Greeting2]] "Mates, I can tell ya' where we're at, I can see it with Mince Pies, its another goddamn rock!"),
										param_bindings = false,
									}),
								},
								param_bindings = false,
						...
						Interjections = {
							PlaceObj('ConversationInterjection', {
								Lines = {
									PlaceObj('ConversationLine', {
										Character = "GCExGumpy",
										Text = T(393584741188, --[[ModItemConversation Enduphere Text voice:GCExGumpy section:Enduphere keyword:Greeting2]] 'Looks like the "no-name" island in Lord of the Flies to me!'),
										param_bindings = false,
									}),
								},
								param_bindings = false,
						...
						Interjections = {
							PlaceObj('ConversationInterjection', {
								Lines = {
									PlaceObj('ConversationLine', {
										Character = "GCExCougar",
										Text = T(214513070916, --[[ModItemConversation Enduphere Text voice:GCExCougar section:Enduphere keyword:Greeting2]] "Soldiers, this must be Seagull island, according to the maps. But where is the other squad?"),
										param_bindings = false,
									}),
								},
								param_bindings = false,
						...
						Interjections = {
							PlaceObj('ConversationInterjection', {
								Lines = {
									PlaceObj('ConversationLine', {
										Character = "GCExGasket",
										Text = T(867674073505, --[[ModItemConversation Enduphere Text voice:GCExGasket section:Enduphere keyword:Greeting2]] "Guess you need ma' smart brains for that, when we capsized we got separated.."),
										param_bindings = false,
									}),
								},
								param_bindings = false,
						...
						Interjections = {
							PlaceObj('ConversationInterjection', {
								Lines = {
									PlaceObj('ConversationLine', {
										Character = "GCExGaston",
										Text = T(880053656039, --[[ModItemConversation Enduphere Text voice:GCExGaston section:Enduphere keyword:Greeting2]] "What a genius observation!"),
										param_bindings = false,
									}),
								},
								param_bindings = false,
						...
						Interjections = {
							PlaceObj('ConversationInterjection', {
								Lines = {
									PlaceObj('ConversationLine', {
										Character = "GCExStogie",
										Text = T(748369031943, --[[ModItemConversation Enduphere Text voice:GCExStogie section:Enduphere keyword:Greeting2]] "Come on guys, enough bantering...The currents are strong, we probably drifted into different directions. Luckily we were close to land! "),
										param_bindings = false,
									}),
								},
								param_bindings = false,
						...
						Interjections = {
							PlaceObj('ConversationInterjection', {
								Lines = {
									PlaceObj('ConversationLine', {
										Character = "GCExCougar",
										Text = T(876818558171, --[[ModItemConversation Enduphere Text voice:GCExCougar section:Enduphere keyword:Greeting2]] "I agree. We have to keep going and find a way off this island or call for help. This is top priority. If the others are still alive there is nothing we can do for them now!"),
										param_bindings = false,
									}),
								},
								param_bindings = false,
		...
		PlaceObj('ModItemSetpiecePrg', {
			Map = "ehvTmk7",
			MapPatchPath = "Mod/GCExPrologue/MapPatches/SetPieces/NewSetpiece_eqQ6Ufq/ehvTmk7.patch",
			affected_grids = {},
			compacted_obj_boxes = {
				box(168782, 228694, 176268, 232023),
			},
			group = "Default",
			hidden_actors = false,
			id = "LandingOnSeagull",
			mapName = "NewSetpiece_eqQ6Ufq",
			obj_hashes = {
				-3777632767178481015,
				-1806104690466274844,
				-9105293520473463851,
			...
			PlaceObj('SetpieceTeleport', {
				Actors = "Merc1",
				AssignTo = "SGLand_merc1",
				Marker = "SGLand_merc1",
			}),
			PlaceObj('SetpieceTeleport', {
				Actors = "Merc2",
				AssignTo = "SGLand_merc2",
				Marker = "SGLand_merc2",
			}),
			PlaceObj('SetpieceTeleport', {
				Actors = "Merc3",
				AssignTo = "SGLand_merc3",
				Marker = "SGLand_merc3",
			}),
			PlaceObj('SetpieceTeleport', {
				Actors = "Merc4",
				AssignTo = "SGLand_merc4",
				Marker = "SGLand_merc4",
			}),
			PlaceObj('SetpieceTeleport', {
				Actors = "Merc5",
				AssignTo = "SGLand_merc5",
				Marker = "SGLand_merc5",
			}),
			PlaceObj('SetpieceTeleport', {
				Actors = "Merc6",
				AssignTo = "SGLand_merc6",
				Marker = "SGLand_merc6",
			}),
			PlaceObj('SetpieceCamera', {
				LookAt1 = point(155249, 233408, 19830),
				Pos1 = point(150374, 233051, 20883),
			}),
			PlaceObj('SetpieceFadeIn', {
				FadeInDelay = 0,
				Wait = false,
			...
			PlaceObj('SetpieceCamera', {
				Duration = 8000,
				Interpolation = "spherical",
				LookAt1 = point(155248, 233408, 19830),
				LookAt2 = point(177296, 220067, 20684),
				Movement = "decelerated",
				Pos1 = point(150374, 233051, 20883),
				Pos2 = point(178124, 215463, 22450),
			}),
			PlaceObj('SetpieceCamera', {
				LookAt1 = point(177296, 220067, 20684),
				Pos1 = point(178124, 215463, 22450),
			}),
			PlaceObj('SetpieceFadeIn', {
				FadeInDelay = 0,
				FadeInTime = 0,
			...
			PlaceObj('SetpieceCamera', {
				...
				Interpolation = "spherical",
				LookAt1 = point(155248, 233408, 19830),
				LookAt2 = point(162934, 241469, 36198),
				Movement = "decelerated",
				Pos1 = point(150374, 233051, 20883),
				Pos2 = point(160805, 243808, 40070),
			}),
			PlaceObj('SetpieceCamera', {
				CamType = "Tac",
				Duration = 0,
				LookAt1 = point(162934, 241469, 36198),
				Pos1 = point(160805, 243808, 40070),
				Zoom = 1300,
			}),
			PlaceObj('SetpieceFadeOut', {
				FadeOutTime = 1700,
		...
		PlaceObj('ModItemQuestsDef', {
			Chapter = "",
			DisplayName = T(879352790726, --[[ModItemQuestsDef VillageEmpty DisplayName]] "Certainly no Blue Lagoon"),
			KillTCEsConditions = {
				PlaceObj('QuestKillTCEsOnCompleted', {}),
			},
			NoteDefs = {
	...
	Given = false,
					...
					Text = T(823949993990, --[[ModItemQuestsDef VillageEmpty Text]] "You should look around for any clues on how to leave the island, there is a village nearby!"),
				}),
				PlaceObj('QuestNote', {
					CompletionConditions = {
						PlaceObj('QuestIsVariableBool', {
	...
	Completed = false,
					...
					Text = T(460172889726, --[[ModItemQuestsDef VillageEmpty Text]] "The inhabitants vanished without a trace! But there is a path leading deeper into the jungle..."),
				}),
			},
			TCEs = {
				PlaceObj('TriggeredConditionalEvent', {
		...
		PlaceObj('ModItemQuestsDef', {
			DisplayName = T(640475582619, --[[ModItemQuestsDef BackgroundQuest DisplayName]] "Tropical Heat"),
			Hidden = true,
			KillTCEsConditions = {
				PlaceObj('QuestKillTCEsOnCompleted', {}),
			},
	...
	Given = false,
					...
					Text = T(784170846763, --[[ModItemQuestsDef BackgroundQuest Text]] "Find a way off this rock, make sure at least one member of the squad survives!"),
				}),
			},
			TCEs = {
				PlaceObj('TriggeredConditionalEvent', {
					...
					Effects = {
						PlaceObj('EndCampaignEffect', {}),
					},
					ParamId = "BackgroundQuest_failed",
					QuestId = "BackgroundQuest",
				}),
			},
			Variables = {
				...
				PlaceObj('QuestVarTCEState', {
					Name = "BackgroundQuest_failed",
				}),
			},
			campaign = "GCEXPrologue",
			group = "BackgroundQuest",
			id = "BackgroundQuest",
		}),
		PlaceObj('ModItemBanterDef', {
			Lines = {
				PlaceObj('BanterLine', {
					'Text', T(645503025729, --[[ModItemBanterDef LoneVillage1_3 Text]] "The stove is still warm...but no one is around here either!\n"),
					'Voiced', false,
				}),
			},
			campaign = "GCEXPrologue",
		...
		PlaceObj('ModItemBanterDef', {
			Lines = {
				PlaceObj('BanterLine', {
					'Text', T(905967690687, --[[ModItemBanterDef LoneVillage1_2 Text]] "There are sure living people here, but where the hell have they gone?"),
					'Voiced', false,
				}),
			},
			campaign = "GCEXPrologue",
		...
		PlaceObj('ModItemBanterDef', {
			Lines = {
				PlaceObj('BanterLine', {
					'Text', T(167110748489, --[[ModItemBanterDef LoneVillage1_1 Text]] "The coffee is still warm, as if someone just left!"),
					'Voiced', false,
				}),
			},
			campaign = "GCEXPrologue",
		...
		PlaceObj('ModItemBanterDef', {
			Lines = {
				PlaceObj('BanterLine', {
					'Text', T(199307589024, --[[ModItemBanterDef LoneVillage1 Text]] "The fire is still burning, someone was just here, only minutes ago!"),
					'Voiced', false,
				}),
			},
			campaign = "GCEXPrologue",
		...
		PlaceObj('ModItemBanterDef', {
			Lines = {
				PlaceObj('BanterLine', {
					'Character', "GCExGaston",
					'Text', T(448489956477, --[[ModItemBanterDef Style Text]] "I don't trust her, though I like her style."),
					'Voiced', false,
				}),
			},
			campaign = "GCEXPrologue",
		...
		PlaceObj('ModItemBanterDef', {
			Lines = {
				PlaceObj('BanterLine', {
					'Character', "GCExStogie",
					'Text', T(248828814463, --[[ModItemBanterDef OnGuard Text]] "We should be on our Guard!"),
					'Voiced', false,
				}),
			},
			campaign = "GCEXPrologue",
		...
		PlaceObj('ModItemBanterDef', {
			Lines = {
				PlaceObj('BanterLine', {
					'Character', "GCExStitches",
					'Text', T(814402362954, --[[ModItemBanterDef Hearyou Text]] "I can hear you, boys!"),
					'Voiced', false,
				}),
			},
			campaign = "GCEXPrologue",
